    ...
    public partial class AddSeedData : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Use these sturdy shoes to pass any mountain range with ease.", new DateTimeOffset(new DateTime(2019, 2, 9, 0, 22, 21, 893, DateTimeKind.Unspecified).AddTicks(3180), new TimeSpan(0, -6, 0, 0, 0)), "Mountain Walkers", "shutterstock_66842440.jpg", 219.5m, 4, 12, 0 },
                    { 2, "For your everyday marches in the army.", new DateTimeOffset(new DateTime(2019, 2, 9, 0, 22, 21, 895, DateTimeKind.Unspecified).AddTicks(4294), new TimeSpan(0, -6, 0, 0, 0)), "Army Slippers", "shutterstock_222721876.jpg", 125.9m, 3, 56, 0 },
                    { 3, "This backpack can survive any tornado.", new DateTimeOffset(new DateTime(2019, 2, 9, 0, 22, 21, 895, DateTimeKind.Unspecified).AddTicks(4331), new TimeSpan(0, -6, 0, 0, 0)), "Backpack Deluxe", "shutterstock_6170527.jpg", 199.99m, 5, 66, 1 },
                    { 4, "Anything you need to climb the mount Everest.", new DateTimeOffset(new DateTime(2019, 2, 9, 0, 22, 21, 895, DateTimeKind.Unspecified).AddTicks(4340), new TimeSpan(0, -6, 0, 0, 0)), "Climbing Kit", "shutterstock_48040747.jpg", 299.5m, 5, 3, 1 },
                    { 5, "Simply the fastest kayak on earth and beyond for 2 persons.", new DateTimeOffset(new DateTime(2019, 2, 9, 0, 22, 21, 895, DateTimeKind.Unspecified).AddTicks(4349), new TimeSpan(0, -6, 0, 0, 0)), "Blue Racer", "shutterstock_441989509.jpg", 350m, 5, 8, 2 },
                    { 6, "One person kayak with hyper boost button.", new DateTimeOffset(new DateTime(2019, 2, 9, 0, 22, 21, 895, DateTimeKind.Unspecified).AddTicks(4356), new TimeSpan(0, -6, 0, 0, 0)), "Orange Demon", "shutterstock_495259978.jpg", 450m, 2, 1, 2 }
                });
