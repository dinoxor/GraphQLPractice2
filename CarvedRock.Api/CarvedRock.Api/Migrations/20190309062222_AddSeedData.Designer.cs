...
namespace CarvedRock.Api.Migrations
{
    ...
    [Migration("20190309062222_AddSeedData")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CarvedRock.Api.Model.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IntroducedAt = new DateTimeOffset(new DateTime(2019, 2, 9, 0, 22, 21, 893, DateTimeKind.Unspecified).AddTicks(3180), new TimeSpan(0, -6, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            IntroducedAt = new DateTimeOffset(new DateTime(2019, 2, 9, 0, 22, 21, 895, DateTimeKind.Unspecified).AddTicks(4294), new TimeSpan(0, -6, 0, 0, 0)),
                            Name = "Army Slippers",
                        ...
                        new
                        {
                            ...
                            IntroducedAt = new DateTimeOffset(new DateTime(2019, 2, 9, 0, 22, 21, 895, DateTimeKind.Unspecified).AddTicks(4331), new TimeSpan(0, -6, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            IntroducedAt = new DateTimeOffset(new DateTime(2019, 2, 9, 0, 22, 21, 895, DateTimeKind.Unspecified).AddTicks(4340), new TimeSpan(0, -6, 0, 0, 0)),
                            Name = "Climbing Kit",
                        ...
                        new
                        {
                            ...
                            IntroducedAt = new DateTimeOffset(new DateTime(2019, 2, 9, 0, 22, 21, 895, DateTimeKind.Unspecified).AddTicks(4349), new TimeSpan(0, -6, 0, 0, 0)),
                            Name = "Blue Racer",
                        ...
                        new
                        {
                            ...
                            IntroducedAt = new DateTimeOffset(new DateTime(2019, 2, 9, 0, 22, 21, 895, DateTimeKind.Unspecified).AddTicks(4356), new TimeSpan(0, -6, 0, 0, 0)),
                            Name = "Orange Demon",
            ...
            modelBuilder.Entity("CarvedRock.Api.Model.ProductReview", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
...
It's pretty bare bones aside from some dry storage areas and some bungees. It does have a bungee to hold your paddle on the side. I feel it paddles very easy. It goes exactly where I want it to, I didn't struggle to keep it on course. A stiff wind can knock you off track but it was very sturdy and I feel like it would take a lot to tip it over. I stayed fairly dry aside from the dripping off the paddle but its a sit on top so thats to be expected.",
            ...
            modelBuilder.Entity("CarvedRock.Api.Model.ProductReview", b =>
                {
                    b.HasOne("CarvedRock.Api.Model.Product", "Product")
